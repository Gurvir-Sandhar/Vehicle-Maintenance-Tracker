    ...
    public class RecordsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Record != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.Record'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Mileage,WorkDone,CreatedDate")] Record @record)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Mileage,WorkDone,CreatedDate")] Record @record)
        {
            if (id != @record.Id)
            {
                return NotFound();
